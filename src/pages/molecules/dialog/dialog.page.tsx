        ...
        <ScrollareaComponent>
          <div style={{ padding: '0px 24px 24px 24px' }}>
            <ParagraphComponent>
              ...
              ultricies. Integer nec sapien sit amet nulla ultrices ultricies. Sed nec metus id
              augue fermentum fermentum. Nullam nec nunc eget libero ultricies ultricies. Sed nec
              metus id augue fermentum fermentum. Nullam nec nunc eget libero ultricies ultricies.
            </ParagraphComponent>
          </div>
        </ScrollareaComponent>
      </DialogComponent>
